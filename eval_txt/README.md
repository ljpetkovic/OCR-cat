...
* Automatic correction of the malformed tags in the ALTO-XML files, using the `corr_ALTO.sh` script (cf. [here](https://github.com/ljpetkovic/OCR-cat/tree/master/ALTO_XML_trans/scripts));
